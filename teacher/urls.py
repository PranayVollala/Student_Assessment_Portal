...
path('teacher/teacher-exam/<int:pk>', views.admin_view_marks_view,name='admin-view-marks'),
path('faculty_view_students', views.faculty_view_students, name='faculty-view-students'),
]