...
urlpatterns = [
    ...
    path('admin_manage_faculty',views.admin_manage_faculty,name='admin_manage_faculty'),
    path('admin_companies',views.admin_companies,name='admin_companies'),
    path('admin/add_companies', views.admin_add_companies, name='admin_add_companies'),
    path('admin_view_companies', views.admin_view_companies, name='admin_view_companies'),
    # path('exam/avg/marks/', views.exam_avg_marks, name='exam_avg_marks'),
    path('student_companies', views.student_companies, name='student_companies'),
    # path('teachers/', views.faculty_view_students, name='faculty-view-students'),
